	...
	<div class="container-fluid"><!-- information-->
		<div class="well well-large">
			...
			<s:else>
				...
				<div class="control-group">
					<label class="control-label" for="registForm_testDataInputEntity_name"><span class="label label-important">サブタイトル</span></label>
					<div class="controls">
						<s:textfield type="text"  name="testDataInputEntity.name"  cssClass="input-xlarge" placeholder="NAME?"  ></s:textfield>
					</div>
				</div>
								...
								<div class="control-group">
					<label class="control-label" for="registForm_testDataInputEntity_name"><span class="label label-important">スポンサー名</span></label>
					<div class="controls">
						<s:textfield type="text"  name="testDataInputEntity.name"  cssClass="input-xlarge" placeholder="NAME?"  ></s:textfield>
					</div>
				</div>
								...
								<div class="control-group">
					<label class="control-label" for="registForm_testDataInputEntity_name"><span class="label label-important">イベント詳細</span></label>
					<div class="controls">
						<s:textfield type="text"  name="testDataInputEntity.name"  cssClass="input-xlarge" placeholder="NAME?"  ></s:textfield>
					</div>
				</div>
								...
								<div class="control-group">
					<label class="control-label" for="registForm_testDataInputEntity_name"><span class="label label-important">場所</span></label>
					<div class="controls">
						<s:textfield type="text"  name="testDataInputEntity.name"  cssClass="input-xlarge" placeholder="NAME?"  ></s:textfield>
					</div>
				</div>
								...
								<div class="control-group">
					<label class="control-label" for="registForm_testDataInputEntity_name"><span class="label label-important">URL</span></label>
					<div class="controls">
						<s:textfield type="text"  name="testDataInputEntity.name"  cssClass="input-xlarge" placeholder="NAME?"  ></s:textfield>
					</div>
				</div>
								...
								<div class="control-group">
					<label class="control-label" for="registForm_testDataInputEntity_name"><span class="label label-important">イベント開始日時</span></label>
					<div class="controls">
						<s:textfield type="text"  name="testDataInputEntity.name"  cssClass="input-xlarge" placeholder="NAME?"  ></s:textfield>
					</div>
				</div>
								...
								<div class="control-group">
					<label class="control-label" for="registForm_testDataInputEntity_name"><span class="label label-important">イベント終了日時</span></label>
					<div class="controls">
						<s:textfield type="text"  name="testDataInputEntity.name"  cssClass="input-xlarge" placeholder="NAME?"  ></s:textfield>
					</div>
				</div>
...
<div class="control-group">
					<label class="control-label" for="registForm_testDataInputEntity_name"><span class="label label-important">イベント受付開始日時</span></label>
					<div class="controls">
						<s:textfield type="text"  name="testDataInputEntity.name"  cssClass="input-xlarge" placeholder="NAME?"  ></s:textfield>
					</div>
				</div>
...
<div class="control-group">
					<label class="control-label" for="registForm_testDataInputEntity_name"><span class="label label-important">イベント受付終了日時</span></label>
					<div class="controls">
						<s:textfield type="text"  name="testDataInputEntity.name"  cssClass="input-xlarge" placeholder="NAME?"  ></s:textfield>
					</div>
				</div>
